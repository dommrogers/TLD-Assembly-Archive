...
public class UtilsPanelChoose
{
	...
	[Calls(Type = typeof(UtilsPanelChoose), Member = "GetLocationAndRegion")]
	...
	private static void GetLocationAndRegion(SaveSlotInfo slotInfo, out string location, out string region)
	{
		location = null;
		region = null;
	}
