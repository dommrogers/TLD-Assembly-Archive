...
public class QueryEntitlementsCallbackInfo : ICallbackInfo, ISettable
{
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(QueryEntitlementsCallbackInfoInternal), Member = "get_ClientData")]
	[Calls(Type = typeof(QueryEntitlementsCallbackInfoInternal), Member = "get_LocalUserId")]
	[CallsDeduplicatedMethods(Count = 1)]
