...
public static class NGUIText
{
	...
	[Calls(Type = typeof(string), Member = "get_Chars")]
	[Calls(Type = typeof(NGUIText), Member = "ParseSymbol")]
	[Calls(Type = typeof(BetterList<>), Member = "get_Item")]
	[Calls(Type = typeof(NGUIText), Member = "GetSymbol")]
	[Calls(Type = typeof(Color32), Member = "op_Implicit")]
	[Calls(Type = typeof(Mathf), Member = "RoundToInt")]
	...
	[Calls(Type = typeof(NGUIText), Member = "IsSpace")]
	[Calls(Type = typeof(Rect), Member = "get_yMax")]
	[Calls(Type = typeof(Color), Member = "Lerp")]
	[Calls(Type = typeof(Vector3), Member = ".ctor")]
	[CallsDeduplicatedMethods(Count = 12)]
	[CallsUnknownMethods(Count = 404)]
