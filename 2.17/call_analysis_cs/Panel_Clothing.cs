...
public class Panel_Clothing : Panel_AutoReferenced, INotificationHandler, IMiniTopNav
{
	[Serializable]
	...
	public Texture2D m_FullbodyTextureMale;

	public Texture2D m_FullbodyTextureFemale;
	...
	private static readonly int s_PaperdollTextureShaderID;
	...
	[Calls(Type = typeof(ClothingItem), Member = "PlayAudioEventWithFallback")]
	[Calls(Type = typeof(ClothingItem), Member = "PlayUnequipAudio")]
	...
	[CalledBy(Type = typeof(ClothingSlot), Member = "UpdateMaskingFromLayeredClothing")]
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(List<>.Enumerator), Member = "MoveNext")]
	[CallsUnknownMethods(Count = 2)]
	public ClothingSlot GetClothingSlot(ClothingRegion region, ClothingLayer layer)
	{
		return null;
	}
	...
	[CalledBy(Type = typeof(Panel_Clothing), Member = "UnequipItemInSelectedSlot")]
	[CallerCount(Count = 3)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(ClothingItem), Member = "PlayUnequipAudio")]
	[Calls(Type = typeof(PlayerManager), Member = "UseInventoryItem")]
	[CallsUnknownMethods(Count = 3)]
	public void UnequipItemInSelectedSlot(bool playAudio)
	{
	}
	...
	[Calls(Type = typeof(ClothingSlot), Member = "UpdateMaskingFromLayeredClothing")]
