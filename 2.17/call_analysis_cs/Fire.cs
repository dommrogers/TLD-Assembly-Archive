...
public class Fire : MonoBehaviour, CraftingLocationInterface
{
	...
	public string GetHeatIncreaseText(bool includeSign = true)
	{
		return null;
	}

	[CalledBy(Type = typeof(Fire), Member = "GetHeatIncreaseText")]
	[CalledBy(Type = typeof(Panel_Cooking), Member = "RefreshFireDurationLabel")]
	[CalledBy(Type = typeof(Panel_CookWater), Member = "RefreshFireDurationLabel")]
	[CallerCount(Count = 3)]
	[Calls(Type = typeof(BaseStateSingleton<>), Member = "get_Instance")]
	[Calls(Type = typeof(Localization), Member = "Get")]
	[Calls(Type = typeof(string), Member = "Format")]
	[CallsUnknownMethods(Count = 2)]
	public string GetHeatIncreaseText(string lastString, ref int warmth, bool includeSign)
	{
		return null;
	}
