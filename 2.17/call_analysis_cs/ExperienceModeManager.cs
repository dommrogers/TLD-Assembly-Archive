...
public class ExperienceModeManager : MonoBehaviour
{
	...
	private AssetReferenceGameModeConfig m_MenuGameModeReference;
	...
	private static GameModeConfig s_MainMenuGameMode;
	...
	[CalledBy(Type = typeof(Panel_SelectChallengeType), Member = "OnClickBack")]
	[CalledBy(Type = typeof(Panel_SelectExperience), Member = "OnClickBack")]
	[CallerCount(Count = 3)]
	...
	[CalledBy(Type = typeof(HUDObjectives), Member = "ShowMapHotkey")]
	[CalledBy(Type = typeof(Panel_Loading), Member = "SetLoadingScreenText")]
	[CalledBy(Type = typeof(SaveGameSystem), Member = "SaveGame")]
	[CalledBy(Type = typeof(Condition_CheckIfChallengeActive), Member = "OnCheck")]
	[CallerCount(Count = 4)]
