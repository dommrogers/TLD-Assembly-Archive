...
public class SaveGameSystem
{
	...
	private sealed class _003CSaveScreenshotDataCoroutine_003Ed__117 : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int _003C_003E1__state;
		...
		[DeduplicatedMethod]
		[CallerCount(Count = 0)]
		public _003CSaveScreenshotDataCoroutine_003Ed__117(int _003C_003E1__state)
		{
		}
	...
	public const string LEGACY_SETTINGS_FILENAME = "usercfg";

	public static string s_SettingsFilename;

	public static string s_LegacySettingsFileName;

	private static string s_MigratedSettingsData;
	...
	[Calls(Type = typeof(SaveGameSystem), Member = "SaveGameModeData")]
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 1)]
	private static void SaveGameModeData(SlotData slot)
	{
	}
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 1)]
	private static void RestoreGameModeData(string slotName)
	{
	}
	...
	[Calls(Type = typeof(Array), Member = "Clear")]
	[Calls(Type = typeof(BigCarrySystem), Member = "Serialize")]
	...
	[Calls(Type = typeof(BigCarrySystem), Member = "Deserialize")]
	...
	[Calls(Type = typeof(TransmitterManager), Member = "DeserializeAll")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	...
	[Calls(Type = typeof(ActiveMissionManager), Member = "Deserialize")]
	...
	[Calls(Type = typeof(ActiveMissionManager), Member = "GetActiveStoryMissionInfo")]
	[Calls(Type = typeof(SaveGameSlots), Member = "SaveDataToSlot")]
	[CallsUnknownMethods(Count = 1)]
	...
	[Calls(Type = typeof(BigCarrySystem), Member = "SerializeScene")]
	[Calls(Type = typeof(GearItemInteractabilityControl), Member = "SerializeAll")]
	[Calls(Type = typeof(SpawnGearVariant), Member = "Serialize")]
	[Calls(Type = typeof(CustomSpawnedItemManager), Member = "SerializeAll")]
	[Calls(Type = typeof(BeachcombingSpawner), Member = "SerializeAll")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Inequality")]
	[Calls(Type = typeof(Utils), Member = "SerializeObject")]
	[Calls(Type = typeof(SaveGameSlots), Member = "SaveDataToSlot")]
	[Calls(Type = typeof(string), Member = "Concat")]
	...
	[Calls(Type = typeof(CustomSpawnedItemManager), Member = "DeserializeAll")]
	...
	[Calls(Type = typeof(BigCarrySystem), Member = "DeserializeScene")]
	...
	[Calls(Type = typeof(BeachcombingSpawner), Member = "DeserializeAll")]
	...
	[IteratorStateMachine(typeof(_003CSaveScreenshotDataCoroutine_003Ed__117))]
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	...
	[CallAnalysisFailed]
	[CallerCount(Count = 0)]
	public static void HandleCheckIfSettingsExists(bool dataExists, string name)
	{
	}
	...
	[CalledBy(Type = typeof(SaveGameDataPC), Member = "GetFullPath")]
	[CalledBy(Type = typeof(SaveGameSystem), Member = "IsSettingsFilename")]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(CompareInfo), Member = "CompareOrdinalIgnoreCase")]
	public static bool IsLegacySettingsFilename(string name)
	{
		return false;
	}
