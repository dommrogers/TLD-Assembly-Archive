...
public class MatchesItem : MonoBehaviour
{
	...
	private AK.Wwise.Event m_IgniteAudioEvent;

	private AK.Wwise.Event m_BurnOutAudioEvent;
	...
	private static readonly MatchesItemSaveDataProxy m_MatchesItemSaveDataProxy;
