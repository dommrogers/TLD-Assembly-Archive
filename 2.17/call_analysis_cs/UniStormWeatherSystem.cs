...
public class UniStormWeatherSystem : MonoBehaviour, IElectrostaticSource
{
	...
	[CalledBy(Type = typeof(UniStormWeatherSystem), Member = "GetElectrostaticFogIntensity")]
	[CalledBy(Type = typeof(UniStormWeatherSystem), Member = "CalculateWeatherChangeAuroraIntensity")]
	[CalledBy(Type = typeof(BeachcombingManager), Member = "OnWeatherChanged")]
	[CallerCount(Count = 5)]
	public float GetNormalizedWeatherTransition()
	{
		return 0f;
	}
	...
	[CalledBy(TypeFullName = "LightingCapture.<CaptureFrame>d__16", Member = "MoveNext")]
