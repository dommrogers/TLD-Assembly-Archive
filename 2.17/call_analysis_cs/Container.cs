...
public class Container : MonoBehaviour, NCUtils.IItemRequirementsCollection
{
	...
	private bool m_DisableSerialization;
	...
	private List<GameObject> m_DynamicMeshPieces;
	...
	[Calls(Type = typeof(Container), Member = "UpdateActiveMeshFromWeight")]
	...
	[CalledBy(Type = typeof(BodyBigCarryItem), Member = "SearchCallback")]
	[CallerCount(Count = 3)]
	...
	[CallsUnknownMethods(Count = 1)]
	public void ShowContainerContents(Action onContainerClosed = null)
	{
	}
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 4)]
	private void UpdateActiveMeshFromWeight(float weight)
	{
	}
	...
	[Calls(TypeFullName = "System.ThrowHelper", Member = "ThrowArgumentOutOfRange_IndexException")]
	[CallsUnknownMethods(Count = 2)]
	public float GetPowderItemAmount(PowderType type)
	{
		return 0f;
	}
