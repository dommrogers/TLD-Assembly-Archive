...
public class CookingPotItem : MonoBehaviour
{
	...
	private static readonly CookingPotItemSaveDataProxy s_CookingPotItemSaveDataProxy;
	...
	public bool HasInInventory(Inventory inventory)
	{
		return false;
	}
	...
	[CalledBy(Type = typeof(CookableItem), Member = "GetCookableItemPotCookability")]
	[CallerCount(Count = 1)]
	[CallsUnknownMethods(Count = 1)]
	...
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(CookingPotItem), Member = "FindCookingSlotForGearPlacePoint")]
	public bool TryGetCookingSlot(out CookingSlot cookingSlot)
	{
		cookingSlot = null;
		return false;
	}

	[CalledBy(Type = typeof(CookingPotItem), Member = "TryGetCookingSlot")]
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	...
	private static CookingSlot FindCookingSlotForGearPlacePoint(GearPlacePoint placePoint, ref Fire fire)
	{
		return null;
	}
	...
	[CallsDeduplicatedMethods(Count = 3)]
	[CallsUnknownMethods(Count = 5)]
	public void DestroyGearItemBeingCooked()
	{
	}
	...
	[CallerCount(Count = 2)]
	[CallsUnknownMethods(Count = 1)]
	public bool CanPickupItemWhileCooking()
	{
		return false;
	}
	...
	[DeduplicatedMethod]
	[CallerCount(Count = 0)]
	public GearPlacePoint GetGearPlacePoint()
	{
		return null;
	}
	...
	[Calls(Type = typeof(Skill_Cooking), Member = "CalculateCondition")]
	[CallsUnknownMethods(Count = 2)]
