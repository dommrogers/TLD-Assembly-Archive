...
public class Panel_Inventory : Panel_AutoReferenced, INotificationHandler, IMiniTopNav
{
	[Serializable]
	...
	[CalledBy(Type = typeof(Panel_Actions), Member = "OnInventory")]
	[CalledBy(Type = typeof(Panel_Harvest), Member = "ExitInterface")]
	[CalledBy(Type = typeof(Panel_Inventory), Member = "OnStatus")]
	...
	[CalledBy(Type = typeof(Panel_Inventory), Member = "ExitInterface")]
	[CalledBy(Type = typeof(Panel_Inventory), Member = "OnMiniTopNavButtonClick")]
