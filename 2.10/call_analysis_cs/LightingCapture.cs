...
{
	private sealed class _003CCaptureFrame_003Ed__16 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		[DeduplicatedMethod]
		[CallerCount(Count = 0)]
		public _003CCaptureFrame_003Ed__16(int _003C_003E1__state)
		{
		}
	...
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(LightingCapture), Member = "MaybeCreateDirectory")]
	...
	[CalledBy(Type = typeof(LightingCapture), Member = "MakeNextDirectoryID")]
	[CallerCount(Count = 2)]
	...
	private static void MaybeCreateDirectory()
	{
	}
	...
	[IteratorStateMachine(typeof(_003CCaptureFrame_003Ed__16))]
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	...
	[CalledBy(Type = typeof(_003CCaptureFrame_003Ed__16), Member = "MoveNext")]
	[CallerCount(Count = 1)]
