...
public class RadialObjectSpawner : MonoBehaviour
{
	...
	private LootTableData m_OverrideLootTableData;
	...
	private readonly List<PendingSpawnData> m_PendingSpawns;

	private readonly List<GameObject> m_Spawns;

	private static RadialObjectSpawnerSaveData m_RadialObjectSpawnerSaveData;

	private static readonly List<Vector3> m_PositionsList;

	private static readonly List<Quaternion> m_RotationsList;

	private static readonly List<string> m_PrefabNamesList;

	private static readonly List<bool> m_UnlockedForDetailMapList;
	...
	private LootTableData ActiveLootTableData
	{
	...
	[CalledBy(Type = typeof(BeachcombingSpawner), Member = "SetBlizzardTable")]
	[CalledBy(Type = typeof(BeachcombingSpawner), Member = "SetStandardTable")]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(RadialObjectSpawner), Member = "GetNextPrefabToSpawn")]
	public void SetOverrideLootTableData(LootTableData overrideLootTableData)
	{
	}
	...
	[Calls(Type = typeof(Array), Member = "Clear")]
	[Calls(Type = typeof(Utils), Member = "GetLargestBoundsRenderer")]
	[Calls(Type = typeof(RadialObjectSpawner), Member = "IsVisibleToPlayer")]
	...
	public void ForceRefreshSpawnedItems()
	{
	}
	...
	private bool IsVisibleToPlayer(Vector3 position, float boundingRadius)
	{
		return false;
	}
	...
	[CalledBy(Type = typeof(RadialObjectSpawner), Member = "SetOverrideLootTableData")]
	[CalledBy(Type = typeof(RadialObjectSpawner), Member = "SpawnObjectAttempt")]
	[CalledBy(Type = typeof(RadialObjectSpawner), Member = "RollRandomNumToSpawn")]
	[CallerCount(Count = 4)]
	[Calls(Type = typeof(RadialObjectSpawner), Member = "get_ActiveLootTableData")]
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 1)]
