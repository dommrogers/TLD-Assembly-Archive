...
public class TransmitterManager : MonoBehaviour
{
	...
	[Calls(Type = typeof(Dictionary<, >), Member = "TryGetValue")]
	[Calls(Type = typeof(TransmitterManager), Member = "TryGetAliasedState")]
	[Calls(Type = typeof(TransmitterRuntimeState), Member = ".ctor")]
	...
	private bool TryGetAliasedState(string savedGuid, out string alias, out TransmitterRuntimeState currentState)
	{
		alias = null;
		currentState = null;
		return false;
