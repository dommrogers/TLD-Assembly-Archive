...
public class GearItem : MonoBehaviour, IInteraction, ITorchLightInteraction, IAlternativeInteraction
{
	public delegate void ConditionChangedEvent(GearItem gi, float previousHP, float currentHP);
	...
	public WeightReductionBuff m_WeightReductionBuff;

	public LureItem m_LureItem;

	public BaitItem m_BaitItem;

	public RecipeItem m_RecipeItem;
	...
	public float CurrentHP
	{
		...
		[CalledBy(Type = typeof(MatchesItem), Member = "Ignite")]
		...
		[CalledBy(Type = typeof(Panel_BodyHarvest), Member = "TransferHideFromCarcassToInventory")]
		[CalledBy(Type = typeof(Panel_BodyHarvest), Member = "TransferGutFromCarcassToInventory")]
	...
	public event ConditionChangedEvent ConditionChanged
	{
		[CompilerGenerated]
		[CallerCount(Count = 0)]
	...
	[Calls(Type = typeof(GearItem), Member = "GetDefaultLocalScale")]
	...
	[CalledBy(Type = typeof(IceFishingHole), Member = "InstantiateFish")]
	[CalledBy(Type = typeof(Panel_Crafting), Member = "RefreshSelectedBlueprint")]
	...
	[CalledBy(Type = typeof(PlayerManager), Member = "ExitInspectGearMode")]
	[CalledBy(Type = typeof(PlayerManager), Member = "RestoreOriginalTransform")]
	...
	[CalledBy(Type = typeof(GearItem), Member = "SerializeToString")]
	[CalledBy(Type = typeof(GearItem), Member = "Clone")]
	[CalledBy(Type = typeof(IceFishingHole), Member = "Serialize")]
	[CallerCount(Count = 5)]
	[Calls(Type = typeof(Component), Member = "GetComponent")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(SerializationUtils), Member = "SerializeObject")]
	...
	public GearItemSaveDataProxy Serialize(bool useStaticProxy = false)
	{
		return null;
	}

	[CalledBy(Type = typeof(GearItem), Member = "Clone")]
	[CalledBy(Type = typeof(GearItem), Member = "InstantiateAndDeserializeGearItem")]
	[CalledBy(Type = typeof(GearItem), Member = "InstantiateAndDeserializeGearItem")]
	[CallerCount(Count = 3)]
	[Calls(Type = typeof(GameManager), Member = "GetPlayerTransform")]
	...
	[Calls(Type = typeof(HandheldShortwaveItem), Member = "Deserialize")]
	...
	public void Deserialize(GearItemSaveDataProxy proxy)
	{
	}
	...
	[CallerCount(Count = 3)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "get_name")]
	[Calls(Type = typeof(GearItem), Member = "SerializeToString")]
	[CallsUnknownMethods(Count = 1)]
	...
	[CalledBy(Type = typeof(Panel_Crafting), Member = "RefreshSelectedBlueprint")]
	[CalledBy(Type = typeof(Inventory), Member = "GetAmountInInventoryInKilograms")]
	[CalledBy(Type = typeof(Inventory), Member = "RemoveAmountFromInventory")]
	[CallerCount(Count = 6)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	...
	[CallerCount(Count = 0)]
	private static float GetLiquidDensity(GearLiquidTypeEnum liquidType)
	{
		return 0f;
	}
	...
	[CallerCount(Count = 2)]
	[CallsUnknownMethods(Count = 1)]
	private static float CalculateLiquidWeight(float liters, GearLiquidTypeEnum liquidType)
	{
		return 0f;
	}
	...
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	public static float CalculateLiquidVolume(float kilograms, GearLiquidTypeEnum liquidType)
	{
		return 0f;
	}
	...
	public GearItem Drop(int numUnits, bool playSound = true, bool stickToFeet = true, bool force = false)
	{
		return null;
	}
	...
	[CalledBy(Type = typeof(GearItem), Member = "Awake")]
	[CalledBy(Type = typeof(GearItem), Member = "ResetLocalScale")]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(AssetHelper), Member = "TryLoadAsset")]
	[CallsDeduplicatedMethods(Count = 2)]
	[CallsUnknownMethods(Count = 3)]
	private Vector3 GetDefaultLocalScale()
	{
		return default(Vector3);
	}
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 2)]
	public bool PerformAlternativeInteraction()
	{
		return false;
	}
	...
	public static GearItem InstantiateGearItem(string prefabName)
	{
		return null;
	}
	...
	[CallerCount(Count = 3)]
	[Calls(Type = typeof(AssetHelper), Member = "TryInstantiateAsset")]
	public static GearItem InstantiateGearItem(AssetReference assetReference)
	{
		return null;
	}
	...
	public static GearItem InstantiateAndDeserializeGearItem(string prefabName, string serializedGearItem, Transform parent = null)
	{
		return null;
	}
	...
	[CallsDeduplicatedMethods(Count = 2)]
	[CallsUnknownMethods(Count = 3)]
	public static GearItem InstantiateAndDeserializeGearItem(string prefabName, GearItemSaveDataProxy proxy, Transform parent = null)
	{
		return null;
	}
	...
	[Calls(Type = typeof(SerializationUtils), Member = "TryDeserializeObject")]
	[Calls(Type = typeof(GearItem), Member = "InstantiateAndDeserializeGearItem")]
	public static GearItem InstantiateAndDeserializeGearItem(AssetReference assetReference, string serializedGearItem, Transform parent = null)
	{
		return null;
	}
	...
	[CallsDeduplicatedMethods(Count = 3)]
	[CallsUnknownMethods(Count = 3)]
	public static GearItem InstantiateAndDeserializeGearItem(AssetReference assetReference, GearItemSaveDataProxy proxy, Transform parent = null)
	{
		return null;
	}
