...
public class WorldMapChangedEvent : GameEvent
{
	...
	[CalledBy(Type = typeof(TransmitterSiteUIController), Member = "SelectNextAvailableWorldMap")]
	[CalledBy(Type = typeof(TransmitterSiteUIController), Member = "OnCurrentZoneLoaded")]
	[CallerCount(Count = 6)]
