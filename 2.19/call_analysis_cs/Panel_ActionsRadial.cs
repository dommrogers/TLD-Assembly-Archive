...
public class Panel_ActionsRadial : Panel_AutoReferenced, INotificationHandler
{
	...
	public RadialInfo m_IceFishingHoleRadialInfo;
	...
	[Calls(Type = typeof(Inventory), Member = "GetHighestConditionGearThatMatchesName")]
	[Calls(Type = typeof(Panel_ActionsRadial), Member = "IsInSnowShelter")]
	[Calls(Type = typeof(Panel_ActionsRadial), Member = "IsInLeanTo")]
	[Calls(Type = typeof(Panel_ActionsRadial), Member = "IsInVehicle")]
	[Calls(Type = typeof(Panel_ActionsRadial), Member = "VehicleHasBuiltInBed")]
	...
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[CallsUnknownMethods(Count = 1)]
	private static bool VehicleHasBuiltInBed()
	{
		return false;
	}
	...
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[CallsUnknownMethods(Count = 2)]
	private static bool IsInLeanTo()
	{
		return false;
	}
	...
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[CallsUnknownMethods(Count = 2)]
	private static bool IsInSnowShelter()
	{
		return false;
	}
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(BigCarrySystem), Member = "MaybeBeginPlacement")]
	[CallsUnknownMethods(Count = 1)]
	...
	[Calls(Type = typeof(RadialMenuArm), Member = "SetEnabled")]
	[CallsUnknownMethods(Count = 2)]
	private void AddRadialSelectionGear(RadialGearDelegate callback, GearItem gi)
	{
	}
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(PanelReference<>), Member = "TryGetPanel")]
	[Calls(Type = typeof(Panel_IceFishingHoleClear), Member = "CanBuildFishingHole")]
	[Calls(Type = typeof(HUDMessage), Member = "AddMessage")]
	[CallsUnknownMethods(Count = 1)]
	public void ShowNoIceFishingHoleMessage()
	{
	}
	...
	[Calls(Type = typeof(BowItem), Member = "GetNumAllArrowsInInventory")]
