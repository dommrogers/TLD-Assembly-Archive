...
public class BaseAi : MonoBehaviour
{
	...
	protected List<float> m_LastSlopeUnderPositionList;

	protected int m_LastPositionsSize;
	...
	protected AiTarget m_PlayerTarget;

	protected AiMode m_CurrentMode;

	private AiMode m_PreviousMode;

	protected float m_TimeInModeSeconds;

	private float m_TimeInModeTODHours;

	protected SpawnRegion m_SpawnRegionParent;

	private AiTarget m_AiTarget;

	protected float m_AiGoalSpeed;
	...
	protected MoveAgent m_MoveAgent;
	...
	public int m_HardenedArrowChanceToFleeFromUnseenAttack;

	public int m_ChanceToFleeAfterProjectileAttack;

	public int m_HardenedArrowChanceToFleeAfterProjectileAttack;
	...
	public int m_FleeFromHardenedArrowImpactDistance;
	...
	protected const float KNOCKDOWN_RADIUS = 2f;

	protected const float GROUP_FLEE_EXIT_SECONDS_MIN = 0.5f;

	protected const float GROUP_FLEE_EXIT_SECONDS_MAX = 1.5f;

	protected const float TIME_TO_START_FLEEING = 1f;

	protected const float SECONDS_BEFORE_AUTO_FLEE_TO_SPAWN = 10f;

	protected const float AUTO_FLEE_TO_SPAWN_MAX_DISTANCE_FROM_FLEEPOS = 30f;

	protected const float AUTO_FLEE_TO_SPAWN_MIN_DISTANCE_FROM_SPAWN = 5f;

	protected Vector3 m_FleeToPos;

	protected bool m_PickedFleeDestination;

	protected bool m_HasPickedForcedFleePos;

	protected float m_FleeingForSeconds;

	protected float m_FleeingForSecondsSinceLastFleeToSpawnPos;
	...
	protected bool m_UseForcedFleePos;
	...
	protected Vector3 m_CurrentGroundNormal;
	...
	protected bool m_PickedWanderDestination;

	private float m_ElapsedWanderHours;

	private float m_WanderDurationHours;

	protected WanderRegion m_WanderRegion;
	...
	public AiBear Bear
	{
		...
		[CalledBy(Type = typeof(Action_SpawnHuntedChallengeBear), Member = "ChallengeBearIsActive")]
	...
	public AiTimberwolf Timberwolf
	{
	...
	[CalledBy(Type = typeof(AiPtarmigan), Member = "Start_Anim")]
	[CallerCount(Count = 1)]
	...
	public virtual void Start_Anim()
	{
	}
	...
	[Calls(Type = typeof(GameAudioManager), Member = "Play3DSound")]
	[Calls(Type = typeof(AiTimberwolf), Member = "CanPerformPassingAttackChance")]
	...
	[CalledBy(Type = typeof(AiTimberwolf), Member = "GetPassingAttackDamageEventTable")]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(ExperienceModeManager), Member = "GetCurrentExperienceMode")]
	[Calls(Type = typeof(ExperienceMode), Member = "GetDamageEventTable")]
	[CallsUnknownMethods(Count = 3)]
	protected static DamageEventTable GetDamageEventsForTag(GameplayTag tag)
	{
		return null;
	}
	...
	[CallsUnknownMethods(Count = 2)]
	protected float GetAverageSlope()
	{
		return 0f;
	}
	...
	[Calls(Type = typeof(AiMoose), Member = "MaybeFleeOnSlope")]
	...
	[CalledBy(Type = typeof(BaseAi), Member = "MaybeFleeOrAttackFromProjectileHit")]
	...
	[CalledBy(Type = typeof(AiBear), Member = "MaybeFleeOrAttackFromProjectileHit")]
	[CalledBy(Type = typeof(AiMoose), Member = "HoldGround")]
	[CalledBy(Type = typeof(AiMoose), Member = "MaybeFleeOrAttackFromProjectileHit")]
	[CallerCount(Count = 12)]
	[Calls(Type = typeof(BaseAi), Member = "CanPathfindToPosition")]
	[Calls(Type = typeof(MoveAgent), Member = "CanFindPath")]
	[Calls(Type = typeof(AiTarget), Member = "IsPlayer")]
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 1)]
	protected void PlayMeleeAttackAudio()
	{
	}
	...
	[CallerCount(Count = 0)]
	public virtual bool IsImposter()
	{
		return false;
	}
	...
	[Calls(Type = typeof(BaseAi), Member = "get_Timberwolf")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(AiTimberwolf), Member = "MaybeForceHideAndSeek")]
	[Calls(Type = typeof(BaseAi), Member = "UpdateAnim")]
	[Calls(Type = typeof(BaseAi), Member = "ProcessDead")]
	[CallsDeduplicatedMethods(Count = 6)]
	[CallsUnknownMethods(Count = 5)]
	public void Update()
	{
	...
	[DeduplicatedMethod]
	[CallerCount(Count = 0)]
	public virtual bool CanProjectileStick()
	{
		return false;
	}
	...
	[Calls(Type = typeof(BaseAi), Member = "get_Moose")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(AiMoose), Member = "ProcessScratchingAntlers")]
	[Calls(Type = typeof(BaseAi), Member = "ProcessPatrolPointsOfInterest")]
	[Calls(Type = typeof(BaseAi), Member = "get_Timberwolf")]
	[Calls(Type = typeof(AiTimberwolf), Member = "ProcessHideAndSeek")]
	[Calls(Type = typeof(AiTimberwolf), Member = "ProcessJoinPack")]
	[Calls(Type = typeof(AiTimberwolf), Member = "DoPassingAttackDamage")]
	[Calls(Type = typeof(BaseAi), Member = "get_BaseWolf")]
	[Calls(Type = typeof(AiBaseWolf), Member = "ProcessHowl")]
	[CallsDeduplicatedMethods(Count = 6)]
	[CallsUnknownMethods(Count = 5)]
	public virtual void ProcessCurrentAiMode()
	{
	}
	...
	[CalledBy(Type = typeof(AiPtarmigan), Member = "DespawnFlyingAnimal")]
	...
	[DeduplicatedMethod]
	[CallerCount(Count = 0)]
	public virtual bool CanBleedOut()
	{
		return false;
	}
	...
	[CallsDeduplicatedMethods(Count = 5)]
	[CallsUnknownMethods(Count = 9)]
	protected virtual float ComputeDistanceForTarget(Vector3 eyePos, AiTarget potentialTarget)
	{
		return 0f;
	}
	...
	[Calls(Type = typeof(BaseAi), Member = "get_Bear")]
	[Calls(Type = typeof(BaseAi), Member = "get_BaseWolf")]
	[Calls(Type = typeof(BaseAi), Member = "get_BaseDeer")]
	[Calls(Type = typeof(BaseAi), Member = "get_Rabbit")]
	[Calls(Type = typeof(PackManager), Member = "InPack")]
	...
	[CalledBy(Type = typeof(AiPtarmigan), Member = "EnterFlee")]
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(BaseAi), Member = "PlayEnterFleeAudio")]
	[Calls(Type = typeof(BaseAi), Member = "MoveAgentStop")]
	...
	public virtual void ProcessFlee()
	{
	}
	...
	[CallsDeduplicatedMethods(Count = 2)]
	[CallsUnknownMethods(Count = 4)]
	public virtual void MaybeFleeOrAttackFromProjectileHit(WeaponSource weapon)
	{
	}
	...
	[CallerCount(Count = 0)]
	protected virtual float GetFleeSpeed()
	{
		return 0f;
	}
	...
	protected bool MaybePickFleeDestinationFromAreaMarkup(out Vector3 fleePos)
	{
	...
	[CallsDeduplicatedMethods(Count = 6)]
	[CallsUnknownMethods(Count = 9)]
	protected bool PickFleeDesination(out Vector3 fleePos)
	{
		fleePos = default(Vector3);
		return false;
	}
	...
	[Calls(Type = typeof(BaseAi), Member = "CanEnterStalking")]
	[Calls(Type = typeof(BaseAi), Member = "ClearTarget")]
	[Calls(Type = typeof(AiMoose), Member = "HoldGround")]
	[CallsDeduplicatedMethods(Count = 2)]
	[CallsUnknownMethods(Count = 8)]
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 2)]
	protected bool IsTargetGoneOrOutOfRange()
	{
		return false;
	}
	...
	[CalledBy(Type = typeof(AiMoose), Member = "EnterScratchingAntlers")]
	[CalledBy(Type = typeof(AiMoose), Member = "OnStumpApproached")]
	[CalledBy(Type = typeof(AiPtarmigan), Member = "ProcessFlee")]
	[CalledBy(Type = typeof(AiTimberwolf), Member = "ProcessHideAndSeek")]
	...
	[CallsDeduplicatedMethods(Count = 1)]
	[CallsUnknownMethods(Count = 1)]
	protected virtual void OrientCharacterControllerToGround()
	{
	}

	[CalledBy(Type = typeof(BaseAi), Member = "OrientCharacterControllerToGround")]
	[CalledBy(Type = typeof(AiPtarmigan), Member = "OrientCharacterControllerToGround")]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(RaycastHit), Member = "get_collider")]
	protected bool GetHitInfoUnderCharacterControllerFromBatch(out RaycastHit hitInfo)
	{
	...
	[CallsDeduplicatedMethods(Count = 2)]
	[CallsUnknownMethods(Count = 3)]
	protected bool GetHitInfoUnderCharacterController(out RaycastHit hitInfo, FindGroundType findGroundType)
	{
		hitInfo = default(RaycastHit);
		return false;
	}
	...
	protected void AlignTransformWithNormal(Vector3 terrainPoint, Vector3 normal, bool isRollConstrained, bool isImmediate)
	{
	}
	...
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(BaseAi), Member = "get_Moose")]
	[Calls(Type = typeof(AiMoose), Member = "MaybeSelectScratchingStump")]
	[Calls(Type = typeof(AiUtils), Member = "GetClosestNavmeshPos")]
	...
	[CalledBy(Type = typeof(AiBaseDeer), Member = ".ctor")]
	[CalledBy(Type = typeof(AiBaseWolf), Member = ".ctor")]
	[CalledBy(Type = typeof(AiBear), Member = ".ctor")]
	[CalledBy(Type = typeof(AiCougar), Member = ".ctor")]
	[CalledBy(Type = typeof(AiDoe), Member = ".ctor")]
	[CalledBy(Type = typeof(AiMoose), Member = ".ctor")]
	[CalledBy(Type = typeof(AiPtarmigan), Member = ".ctor")]
	[CalledBy(Type = typeof(AiRabbit), Member = ".ctor")]
	[CalledBy(Type = typeof(AiStag), Member = ".ctor")]
	[CalledBy(Type = typeof(AiStagWhite), Member = ".ctor")]
	[CalledBy(Type = typeof(AiTimberwolf), Member = ".ctor")]
	[CalledBy(Type = typeof(AiWolf), Member = ".ctor")]
	[CallerCount(Count = 12)]
