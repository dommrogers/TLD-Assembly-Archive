...
public class StatusBar : MonoBehaviour
{
	...
	public UISprite m_DebuffFillSprite;
	...
	private void GetFillValues(out float normalizedValue, out float fill, out float modifierFill)
	{
	...
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	protected virtual void GetFillValuesThirst(out float normalizedValue, out float fill, out float modifierFill)
	{
		normalizedValue = default(float);
		fill = default(float);
		modifierFill = default(float);
	...
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	protected virtual void GetFillValuesHunger(out float normalizedValue, out float fill, out float modifierFill)
	{
		normalizedValue = default(float);
		fill = default(float);
		modifierFill = default(float);
	...
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	protected virtual void GetFillValuesCold(out float normalizedValue, out float fill, out float modifierFill)
	{
		normalizedValue = default(float);
		fill = default(float);
		modifierFill = default(float);
	...
	[CallerCount(Count = 0)]
	[CallsUnknownMethods(Count = 1)]
	protected virtual void GetFillValuesFatigue(out float normalizedValue, out float fill, out float modifierFill)
	{
		normalizedValue = default(float);
		fill = default(float);
		modifierFill = default(float);
	...
	[CallsUnknownMethods(Count = 1)]
	protected virtual void GetFillValuesCondition(out float normalizedValue, out float fill, out float modifierFill)
	{
		normalizedValue = default(float);
		fill = default(float);
		modifierFill = default(float);
	...
	[CalledBy(Type = typeof(StatusBar), Member = "UpdateForceShow")]
	[CallerCount(Count = 5)]
