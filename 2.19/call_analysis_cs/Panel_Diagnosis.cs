...
public class Panel_Diagnosis : Panel_AutoReferenced
{
	...
	[CalledBy(Type = typeof(Panel_Diagnosis), Member = "RefreshRightPage")]
	[CallerCount(Count = 1)]
	...
	[Calls(Type = typeof(UILabel), Member = "set_text")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "GetAfflictionsRemediesParams")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateStandardTreatmentUI")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateAlternateTreatmentUI")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateRestUI")]
	[Calls(Type = typeof(NPCAffliction), Member = "RequiresRemdy")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(GameObject), Member = "SetActive")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "CanApplyTreatment")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "EnableApplyTreatmentUI")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateHasTreatments")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "EnableApplyTreatmentButton")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "GetSelectedAffliction")]
	[Calls(Type = typeof(string), Member = "ToUpper")]
	[Calls(Type = typeof(string), Member = "Format")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateBodyIconActiveAnimation")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateBodyIconColors")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "UpdateAllButSelectedBodyIconColors")]
	[Calls(Type = typeof(Utils), Member = "SetActive")]
	[Calls(Type = typeof(Panel_Diagnosis), Member = "HideRightPage")]
