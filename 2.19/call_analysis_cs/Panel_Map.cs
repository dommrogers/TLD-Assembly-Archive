...
public class Panel_Map : Panel_AutoReferenced, INotificationHandler, IMiniTopNav
{
	...
	[CalledBy(Type = typeof(_003C_003Ec__DisplayClass155_0), Member = "<AddRegionMap>b__0")]
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(AsyncOperationHandle<>), Member = "get_Result")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "op_Implicit")]
	[Calls(Type = typeof(UnityEngine.Object), Member = "get_name")]
	...
	[CallsDeduplicatedMethods(Count = 2)]
	[CallsUnknownMethods(Count = 3)]
	private void HandleMiniTopNavPrevious()
	{
	}
