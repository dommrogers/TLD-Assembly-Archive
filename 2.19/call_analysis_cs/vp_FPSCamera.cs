...
public class vp_FPSCamera : vp_Component
{
	...
	[CalledBy(Type = typeof(vp_FPSCamera), Member = "GetFPSItemGameObject")]
	[CalledBy(Type = typeof(vp_FPSCamera), Member = "SetWeapon")]
	[CalledBy(Type = typeof(vp_FPSCamera), Member = "EnableEffectsForWeapon")]
	[CalledBy(Type = typeof(vp_FPSPlayer), Member = "SetWeapon")]
	[CalledBy(Type = typeof(vp_FPSPlayer), Member = "SetWeaponAvailable")]
	[CalledBy(Type = typeof(vp_FPSPlayer), Member = "IsWeaponAvailable")]
	[CalledBy(Type = typeof(BowItem), Member = "MakeArrowChildOfBow")]
	[CalledBy(Type = typeof(BowItem), Member = "RemoveArrowChildFromBow")]
	[CalledBy(Type = typeof(FirstPersonItem), Member = "TryGetFPSWeapon")]
	...
	[CalledBy(Type = typeof(PlayerAnimation), Member = "FirstPersonHandsEnabled")]
